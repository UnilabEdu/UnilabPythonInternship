...
class SignPetition(FlaskForm):
    ...
    personal_id = IntegerField("Personal ID", validators=[DataRequired()], render_kw={"class": "form-control", 
                                                                       "placeholder": "Personal ID",
                                                                        "style": "background-color:#ce5a67; border: 0px;"})
    sex = SelectField("Surname", validators=[DataRequired()], 
                      choices=[("other", "აირჩიეთ სქესი"), ("male", "მამრობითი"), ("female", "მდედრობითი"), ("other", "სხვა")], 
    ...
    city = SelectField("City", validators=[DataRequired()], 
                      choices=[("tbilisi", "თბილისი"), ("batumi", "ბათუმი"), ("kutaisi", "ქუთაისი"), ("rustavi", "რუსთავი"), ("gori", "გორი"), ("poti", "ფოთი")], 
                      render_kw={"class": "form-control", 
                        "placeholder": "City",
                        "style": "background-color:#ce5a67; border: 0px;"})
