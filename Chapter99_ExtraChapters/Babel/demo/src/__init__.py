...
from src.extensions import db, migrate, login_manager, mail, babel
...
from src.commands import init_db_command, populate_db_command, send_email_command

BLUEPRINTS = [main_blueprint, product_blueprint, auth_blueprint]
COMMANDS = [init_db_command, populate_db_command, send_email_command]
